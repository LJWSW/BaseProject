...
#define FOREGROUND_STAR_IMAGE_NAME @"icon_star_normal"
#define BACKGROUND_STAR_IMAGE_NAME @"icon_star_selected"
...
- (instancetype)initWithFrame:(CGRect)frame numberOfStars:(NSInteger)numberOfStars foregroundStarImageName:(NSString *)strForegroundStarImageName backgroundStarImageName:(NSString *)strBackgroundStarImageName
{
    if (self = [super initWithFrame:frame])
    {
        ...
        self.foregroundStarView = [self createStarViewWithImage:strForegroundStarImageName];
        self.backgroundStarView = [self createStarViewWithImage:strBackgroundStarImageName];
...
- (void)setBNeedChange:(BOOL)bNeedChange
{
    if (bNeedChange)
    {
